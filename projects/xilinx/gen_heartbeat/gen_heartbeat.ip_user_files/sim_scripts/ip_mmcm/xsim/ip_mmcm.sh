...
#
# Generated by Vivado on Sat Nov 11 12:24:14 +0100 2023
# SW Build 3671981 on Fri Oct 14 05:00:03 MDT 2022
#
# Tool Version Limit: 2022.10 
#
# usage: ip_mmcm.sh [-help]
# usage: ip_mmcm.sh [-lib_map_path]
# usage: ip_mmcm.sh [-noclean_files]
# usage: ip_mmcm.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "ip_mmcm.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ip_mmcm xil_defaultlib.ip_mmcm xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  ip_mmcm -key {Behavioral:sim_1:Functional:ip_mmcm} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./ip_mmcm.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
{
  file="xsim.ini"
  lib_map_path="C:/Applications/Xilinx/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ip_mmcm.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./ip_mmcm.sh -help\" for more information)\n"
    exit 1
  fi
